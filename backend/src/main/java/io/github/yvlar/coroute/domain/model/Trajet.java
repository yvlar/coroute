...
public class Trajet {
  ...
  @Id private UUID id;
  @Property private String conducteurId;
  @Property private String depart;
  @Property private String destination;
  @Property private LocalDate date;
  @Property private LocalTime heure;
  @Property private int placesDisponibles;
  @Property private double prixParPassager;
  @Property private TrajetType type;
  @Property private List<JourSemaine> joursRecurrence;
  @Property private LocalDate dateDebut;
  @Property private LocalDate dateFin;
  @Property private List<Reservation> reservations;
  ...
  public void verifierProprietaire(final String candidatConducteurId) {
    if (!this.conducteurId.equals(candidatConducteurId)) {
      throw new AccesInterditException(
          "accéder aux réservations d'un trajet dont vous n'êtes pas le conducteur");
    }
  }
